...
local panelLogoPath = "cv_logo.png"
local fonts = {
    title = "bankgothic",
    subtitle = "clear",
    text = "clear"
...
local colors = {
    ...
    screen = tocolor(16, 17, 20, 255),
    card = tocolor(27, 29, 35, 255),
    cardHover = tocolor(40, 43, 53, 255),
    accent = tocolor(196, 28, 28, 255),
    accentSoft = tocolor(233, 54, 54, 255),
    accentDark = tocolor(120, 15, 15, 255),
    text = tocolor(236, 236, 236, 255),
...
local function renderPanel()
    ...
    drawRoundedRect(panel.screenArea.x + 22, panel.screenArea.y + 18, 290, 66, colors.accent, 18)
    ...
    dxDrawText("PAINEL CV", panel.screenArea.x + 120, panel.screenArea.y + 24, panel.screenArea.x + 360, panel.screenArea.y + 72, colors.text, 1.22, fonts.title, "left", "center")
